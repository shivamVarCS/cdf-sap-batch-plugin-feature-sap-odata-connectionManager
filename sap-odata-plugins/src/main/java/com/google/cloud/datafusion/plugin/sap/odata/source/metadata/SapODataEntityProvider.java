...
/**
 * This {@code SapODataEntityProvider} contains reusable SAP OData service metadata functions.
 * This holds the SAP OData service entity metadata details and basis that it returns the required details such as
 ...
 */
public class SapODataEntityProvider {
  private static final Logger LOGGER = LoggerFactory.getLogger(SapODataEntityProvider.class);

  private final Edm edmMetadata;

  public SapODataEntityProvider(Edm edmMetadata) {

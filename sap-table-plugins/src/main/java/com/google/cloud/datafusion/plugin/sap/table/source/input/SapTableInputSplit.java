 ...
 * @author sankalpbapat
 */
public class SapTableInputSplit extends InputSplit implements Writable {
  private long start;
  private long end;
  ...
  public SapTableInputSplit() {
  }

  public SapTableInputSplit(long start, long end, long packageSize) {
    this.start = start;
    this.end = end;
